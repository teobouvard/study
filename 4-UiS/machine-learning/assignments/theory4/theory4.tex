...
\begin{enumerate}[a)]
    ...
    \item If we colour the positive side of the discriminant function in red and the negative side in blue, we get the following regions.
    ...
    \item We apply the Batch Perceptron algorithm
