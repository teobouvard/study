...
%nValMax = 20;
nValMin = valPropreChoisie;                                                 %pour ne calculer que les valeurs nécéssaires
...
vectorT = vectPropresMin(:,valPropreChoisie);                               %on attribue à chaque maille la composante du vecteur propre associé
